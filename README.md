...
Command class is used to store information about the commands being passed into the input. \When designing the shell the first thing that was necessary was to address the output of
